...
typedef NS_ENUM(NSInteger, FCWKERRORCODE)
{
    ...
    FCWKERRORCODE_TEMPLATEBINFILENOTEXIST = 2000,                //表盘模版 bin 文件不存在
    FCWKERRORCODE_BKIMAGENOTVALID = 2001,                        //表盘背景图不正确
    FCWKERRORCODE_PREVIEWNOTVALID = 2002,                        //表盘预览图不正确
    FCWKERRORCODE_TEMPLATEBINCOPYFAILURE = 2003,                 //表盘模版 bin 文件拷贝失败
    ...
    FCWKERRORCODE_BADTEMPLATEFILE = 2010,                         //表盘模版 bin 文件不正确（*特别注意：不要使用烧录版本的表盘文件）
    FCWKERRORCODE_BADPUSHINDEX = 3001,                           //错误的表盘推送位置 (索引)
    FCWKERRORCODE_TEMPLATEBINFILEBADSIZE = 3002,                 //表盘模版 bin 文件长度不正确
    FCWKERRORCODE_BADWATCHFACENO = 3003,                         //非法的表盘编号
    FCWKERRORCODE_BADTEMPLATEBIN = 3004,                         //表盘模版 bin 文件不正确
