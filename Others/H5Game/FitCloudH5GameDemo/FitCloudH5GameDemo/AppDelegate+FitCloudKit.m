...
{
    //XLOG_INFO(@"%@", APP_LOG_STRING(@"收到GSensor数据：x: %@, y: %@, z: %@", @(xGravity), @(yGravity), @(zGravity)));
    [[NSNotificationCenter defaultCenter] postNotificationName:GSENSOR_DATA_NOTIFICATION object:@{@"xGravity": @(xGravity), @"yGravity": @(yGravity), @"zGravity": @(zGravity)}];
}
