...
2. Invoke FitCloudWFKit to modify the background / preview / date position of the watchface and generate a new one.
...
#### Invoke FitCloudWFKit to modify the background / preview / date position of the watchface and generate a new one.
