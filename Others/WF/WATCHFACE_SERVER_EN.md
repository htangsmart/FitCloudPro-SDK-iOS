...
#### Invoke FitCloudWFKit to modify the push position at the watch of the watchface bin file and generate a new one.（Optional）

   If you would like to specify the push postion at the watch of the watchface bin file, you can invoke FitCloudWFKit again to modify it, otherwise, skip this step.
