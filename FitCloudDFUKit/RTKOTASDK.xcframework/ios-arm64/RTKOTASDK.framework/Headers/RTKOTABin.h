...
//    RTKOTAImageType_Bee2_APP_DATA10,            ///< App Data 10
    ...
    /*Bee3Pro Bee4*/
    RTKOTAImageType_Bee3Pro_OTAHeader               = 32,
    RTKOTAImageType_Bee3Pro_SecurePatch             = 33,
    RTKOTAImageType_Bee3Pro_SecureAPP               = 34,
    RTKOTAImageType_Bee3Pro_SecureAPPData           = 35,
    RTKOTAImageType_Bee3Pro_PMCPatch                = 36,
    RTKOTAImageType_Bee3Pro_BTSystemPatch           = 37,
    RTKOTAImageType_Bee3Pro_BTLowerStackPatch       = 39,
    RTKOTAImageType_Bee3Pro_NonSecurePatch          = 40,
    RTKOTAImageType_Bee3Pro_UpperStack              = 41,
    RTKOTAImageType_Bee3Pro_APP                     = 42,
    RTKOTAImageType_Bee3Pro_APPConfigData           = 43,
    RTKOTAImageType_Bee3Pro_DSPPatch                = 44,
    RTKOTAImageType_Bee3Pro_DSPAPP                  = 45,
    RTKOTAImageType_Bee3Pro_DSPData                 = 46,
    RTKOTAImageType_Bee3Pro_APPData1                = 47,
    RTKOTAImageType_Bee3Pro_APPData2                = 48,
    RTKOTAImageType_Bee3Pro_APPData3                = 49,
    RTKOTAImageType_Bee3Pro_APPData4                = 50,
    RTKOTAImageType_Bee3Pro_APPData5                = 51,
    RTKOTAImageType_Bee3Pro_APPData6                = 52,
    
    RTKOTAImageType_Bee4_UserData8                  = 120,
    RTKOTAImageType_Bee4_UserData7                  = 121,
    RTKOTAImageType_Bee4_UserData6                  = 122,
    RTKOTAImageType_Bee4_UserData5                  = 123,
    RTKOTAImageType_Bee4_UserData4                  = 124,
    RTKOTAImageType_Bee4_UserData3                  = 125,
    RTKOTAImageType_Bee4_UserData2                  = 126,
    RTKOTAImageType_Bee4_UserData1                  = 127,
    
    RTKOTAImageType_Bee4_BootPatch                  = 2,
