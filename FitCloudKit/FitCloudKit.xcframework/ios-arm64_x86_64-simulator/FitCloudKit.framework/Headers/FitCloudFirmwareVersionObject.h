...
/// 手表硬件支持的功能，手机APP根据该项判断在手机APP上是否显示或使用该功能
...
/// 是否支持将天气推送开关的状态状态同步给手表，当该标志位为true时，app可以将当前天气推送开关的状态同步给手表
...
/// 是否支持Apple Music、Zoom & Tiktok 提醒
...
/// 是否支持更多的二维码传输，收款码：Paytm收款码/PhonePe收款码/GPay收款码/BHTM收款码，名片：Email名片/Phone名片/LinkedIn名片
...
/// 是否支持查询其他固件模块版本信息(如GPS固件版本、4G Modem固件版本等)
