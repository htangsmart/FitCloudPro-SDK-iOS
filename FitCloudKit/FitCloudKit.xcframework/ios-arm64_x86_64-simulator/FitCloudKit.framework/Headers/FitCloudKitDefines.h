...
typedef NS_ENUM(NSInteger, FITCLOUDKITERROR) {
    ...
    /// 当前 PCM/Opus 音频流状态不允许执行所请求的操作
    FITCLOUDKITERROR_PCMAUDIOSTREAMINVALIDSTATE = 81001,
    /// 创建 Opus 编码器失败
    FITCLOUDKITERROR_OPUSENCODERCREATEFAILURE = 81002,
    /// 配置 Opus 编码器失败
    FITCLOUDKITERROR_OPUSENCODERCONFIGFAILURE = 81003,
    /// PCM 音频 Opus 编码失败
    FITCLOUDKITERROR_OPUSAUDIOENCODEFAILURE = 81004,
    /// 封装后的 Opus BLE 数据帧超过当前特征写入上限
    FITCLOUDKITERROR_OPUSBLEFRAMEEXCEEDWRITELIMIT = 81005,
    /// PCM/Opus 音频流因未分类的内部异常而终止
    FITCLOUDKITERROR_PCMAUDIOSTREAMINTERNALFAILURE = 81006,
    /// Opus 音频数据发送超时
    FITCLOUDKITERROR_OPUSBLEWRITETIMEOUT = 81007,
    /// 当前已有 AI 功能会话或控制操作正在进行
    FITCLOUDKITERROR_AIFUNCTIONSESSIONBUSY = 82001,
    /// 当前 AI 功能会话状态不允许执行所请求的操作
    FITCLOUDKITERROR_AIFUNCTIONSESSIONINVALIDSTATE = 82002,
    /// AI 功能控制响应与请求不匹配
    FITCLOUDKITERROR_AIFUNCTIONRESPONSEMISMATCH = 82003,
};
...
typedef NS_ENUM(NSInteger, FITCLOUDDEVICEFEATURE) {
    ...
    /// Voice ride hailing
    FITCLOUDDEVICEFEATURE_VOICERIDEHAILING,
...
#pragma mark - AIAsking

/// AIAsking result type.
typedef NS_ENUM(NSInteger, FitCloudAIAskingResultType) {
    /// Error text generated by the app itself
    FitCloudAIAskingResultTypeCustomErrorText,
    /// AI response text
    FitCloudAIAskingResultTypeResponseText,
    /// Internet connection is offline
    FitCloudAIAskingResultTypeInternetConnectionOffline,
    /// Unknown error
    FitCloudAIAskingResultTypeUnknownError,
};
...
/// The workout type
typedef NS_ENUM(NSInteger, FitCloudWorkoutType) {
    /// Unknown
    FitCloudWorkoutTypeUnknown = -1,
    /// Outdoor Cycling
    FitCloudWorkoutTypeOutdoorCycling = 0x00,
    /// Outdoor Running
    FitCloudWorkoutTypeOutdoorRun = 0x01,
    /// Indoor Running
    FitCloudWorkoutTypeIndoorRun = 0x02,
    /// Outdoor Walking
    FitCloudWorkoutTypeOutdoorWalk = 0x03,
    /// Mountaineering
    FitCloudWorkoutTypeMountaineering = 0x04,
    /// Basketball
    FitCloudWorkoutTypeBasketball = 0x05,
    /// Swimming
    FitCloudWorkoutTypeSwimming = 0x06,
    /// Badminton
    FitCloudWorkoutTypeBadminton = 0x07,
    /// Football
    FitCloudWorkoutTypeFootball = 0x08,
    /// Elliptical Trainer
    FitCloudWorkoutTypeEllipticalTrainer = 0x09,
    /// Yoga
    FitCloudWorkoutTypeYoga = 0x0a,
    /// Table Tennis
    FitCloudWorkoutTypeTableTennis = 0x0b,
    /// Jump Rope
    FitCloudWorkoutTypeJumpRope = 0x0c,
    /// Rowing Machine
    FitCloudWorkoutTypeRowingMachine = 0x0d,
    /// Lazy Car
    FitCloudWorkoutTypeLazyCar = 0x0e,
    /// Exercise Bike
    FitCloudWorkoutTypeExerciseBike = 0x0f,
    /// Free Training
    FitCloudWorkoutTypeFreeTraining = 0x10,
    /// Tennis
    FitCloudWorkoutTypeTennis = 0x11,
    /// Baseball
    FitCloudWorkoutTypeBaseball = 0x12,
    /// Rugby
    FitCloudWorkoutTypeRugby = 0x13,
    /// Cricket
    FitCloudWorkoutTypeCricket = 0x14,
    /// Free Movement
    FitCloudWorkoutTypeFreeMovement = 0x15,
    /// Strength Training
    FitCloudWorkoutTypeStrengthTraining = 0x16,
    /// Indoor Walking
    FitCloudWorkoutTypeIndoorWalk = 0x17,
    /// Indoor Cycling
    FitCloudWorkoutTypeIndoorCycle = 0x18,
    /// Dumbbell
    FitCloudWorkoutTypeDumbbell = 0x19,
    /// Dance
    FitCloudWorkoutTypeDance = 0x1a,
    /// Hula Hoop
    FitCloudWorkoutTypeHulaHoop = 0x1b,
    /// Golf
    FitCloudWorkoutTypeGolf = 0x1c,
    /// Long Jump
    FitCloudWorkoutTypeLongJump = 0x1d,
    /// Sit-up
    FitCloudWorkoutTypeSitUp = 0x1e,
    /// Volleyball
    FitCloudWorkoutTypeVolleyball = 0x1f,
    /// Parkour
    FitCloudWorkoutTypeParkour = 0x20,
    /// Hiking
    FitCloudWorkoutTypeHiking = 0x21,
    /// Hockey
    FitCloudWorkoutTypeHockey = 0x22,
    /// Boating
    FitCloudWorkoutTypeBoating = 0x23,
    /// HIIT
    FitCloudWorkoutTypeHIIT = 0x24,
    /// Softball
    FitCloudWorkoutTypeSoftball = 0x25,
    /// Trail Running
    FitCloudWorkoutTypeTrailRunning = 0x26,
    /// Skiing
    FitCloudWorkoutTypeSkiing = 0x27,
    /// Air Walker
    FitCloudWorkoutTypeAirWalker = 0x28,
    /// Cooldown
    FitCloudWorkoutTypeCooldown = 0x29,
    /// Cross Training
    FitCloudWorkoutTypeCrossTraining = 0x2a,
    /// Pilates
    FitCloudWorkoutTypePilates = 0x2b,
    /// CrossFit
    FitCloudWorkoutTypeCrossFit = 0x2c,
    /// Functional Training
    FitCloudWorkoutTypeFunctionalTraining = 0x2d,
    /// Physical Training
    FitCloudWorkoutTypePhysicalTraining = 0x2e,
    /// Mixed Cardio
    FitCloudWorkoutTypeMixedCardio = 0x2f,
    /// Latin Dance
    FitCloudWorkoutTypeLatinDance = 0x30,
    /// Street Dance
    FitCloudWorkoutTypeStreetDance = 0x31,
    /// Kickboxing
    FitCloudWorkoutTypeKickboxing = 0x32,
    /// Barre
    FitCloudWorkoutTypeBarre = 0x33,
    /// Australian Football
    FitCloudWorkoutTypeAustralianFootball = 0x34,
    /// Bowling
    FitCloudWorkoutTypeBowling = 0x35,
    /// Racquetball
    FitCloudWorkoutTypeRacquetball = 0x36,
    /// Curling
    FitCloudWorkoutTypeCurling = 0x37,
    /// Snowboarding
    FitCloudWorkoutTypeSnowboarding = 0x38,
    /// Fishing
    FitCloudWorkoutTypeFishing = 0x39,
    /// Disc Sports
    FitCloudWorkoutTypeDiscSports = 0x3a,
    /// Downhill Skiing
    FitCloudWorkoutTypeDownhillSkiing = 0x3b,
    /// Core Training
    FitCloudWorkoutTypeCoreTraining = 0x3c,
    /// Skating
    FitCloudWorkoutTypeSkating = 0x3d,
    /// Fitness Gaming
    FitCloudWorkoutTypeFitnessGaming = 0x3e,
    /// Aerobics
    FitCloudWorkoutTypeAerobics = 0x3f,
    /// Group Training
    FitCloudWorkoutTypeGroupTraining = 0x40,
    /// Kendo
    FitCloudWorkoutTypeKendo = 0x41,
    /// Fencing
    FitCloudWorkoutTypeFencing = 0x42,
    /// Stairs
    FitCloudWorkoutTypeStairs = 0x43,
    /// American Football
    FitCloudWorkoutTypeAmericanFootball = 0x44,
    /// Rolling
    FitCloudWorkoutTypeRolling = 0x45,
    /// Pickleball
    FitCloudWorkoutTypePickleball = 0x46,
    /// Boxing
    FitCloudWorkoutTypeBoxing = 0x47,
    /// Taekwondo
    FitCloudWorkoutTypeTaekwondo = 0x48,
    /// Karate
    FitCloudWorkoutTypeKarate = 0x49,
    /// Flexibility
    FitCloudWorkoutTypeFlexibility = 0x4a,
    /// Handball
    FitCloudWorkoutTypeHandball = 0x4b,
    /// Hand Cycling
    FitCloudWorkoutTypeHandCycling = 0x4c,
    /// Mind Body
    FitCloudWorkoutTypeMindBody = 0x4d,
    /// Wrestling
    FitCloudWorkoutTypeWrestling = 0x4e,
    /// Step Training
    FitCloudWorkoutTypeStepTraining = 0x4f,
    /// Tai Chi
    FitCloudWorkoutTypeTaiChi = 0x50,
    /// Gymnastics
    FitCloudWorkoutTypeGymnastics = 0x51,
    /// Athletics
    FitCloudWorkoutTypeAthletics = 0x52,
    /// Martial Arts
    FitCloudWorkoutTypeMartialArts = 0x53,
    /// Casual
    FitCloudWorkoutTypeCasual = 0x54,
    /// Snow Sports
    FitCloudWorkoutTypeSnowSports = 0x55,
    /// Lacrosse
    FitCloudWorkoutTypeLacrosse = 0x56,
    /// Single Bar
    FitCloudWorkoutTypeSingleBar = 0x57,
    /// Parallel Bars
    FitCloudWorkoutTypeParallelBars = 0x58,
    /// Roller Skating
    FitCloudWorkoutTypeRollerSkating = 0x59,
    /// Darts
    FitCloudWorkoutTypeDarts = 0x5a,
    /// Archery
    FitCloudWorkoutTypeArchery = 0x5b,
    /// Horse Riding
    FitCloudWorkoutTypeHorseRiding = 0x5c,
    /// Shuttlecock
    FitCloudWorkoutTypeShuttlecock = 0x5d,
    /// Ice Hockey
    FitCloudWorkoutTypeIceHockey = 0x5e,
    /// Waist and Abdominal Training
    FitCloudWorkoutTypeWaistTraining = 0x5f,
    /// VO2 Max Test
    FitCloudWorkoutTypeVO2maxTest = 0x60,
    /// Judo
    FitCloudWorkoutTypeJudo = 0x61,
    /// Trampoline
    FitCloudWorkoutTypeTrampoline = 0x62,
    /// Skateboarding
    FitCloudWorkoutTypeSkateboarding = 0x63,
    /// Hoverboard
    FitCloudWorkoutTypeHoverboard = 0x64,
    /// Blading
    FitCloudWorkoutTypeBlading = 0x65,
    /// Treadmill
    FitCloudWorkoutTypeTreadmill = 0x66,
    /// Diving
    FitCloudWorkoutTypeDiving = 0x67,
    /// Surfing
    FitCloudWorkoutTypeSurfing = 0x68,
    /// Snorkeling
    FitCloudWorkoutTypeSnorkeling = 0x69,
    /// Pull-up
    FitCloudWorkoutTypePullUp = 0x6a,
    /// Push-up
    FitCloudWorkoutTypePushUp = 0x6b,
    /// Planking
    FitCloudWorkoutTypePlanking = 0x6c,
    /// Rock Climbing
    FitCloudWorkoutTypeRockClimbing = 0x6d,
    /// High Jump
    FitCloudWorkoutTypeHighJump = 0x6e,
    /// Bungee Jumping
    FitCloudWorkoutTypeBungeeJumping = 0x6f,
    /// Folk Dance
    FitCloudWorkoutTypeFolkDance = 0x70,
    /// Hunting
    FitCloudWorkoutTypeHunting = 0x71,
    /// Shooting
    FitCloudWorkoutTypeShooting = 0x72,
    /// Marathon
    FitCloudWorkoutTypeMarathon = 0x73,
    /// Spinning Bike
    FitCloudWorkoutTypeSpinningBike = 0x74,
    /// Pool Swimming
...
/// Companion Workout Event Definitions
typedef NS_ENUM(NSInteger, FitCloudCompanionWorkoutEvent) {
    /// Stop
    FitCloudCompanionWorkoutEventStop = 0x00,
    /// Start
    FitCloudCompanionWorkoutEventStart = 0x01,
    /// Pause
    FitCloudCompanionWorkoutEventPause = 0x02,
    /// Resume
    FitCloudCompanionWorkoutEventResume = 0x03,
};

/// Companion Workout State Definitions
typedef NS_ENUM(NSInteger, FitCloudCompanionWorkoutState) {
    /// Completed
    FitCloudCompanionWorkoutStateCompleted = 0x00,
    /// Active
    FitCloudCompanionWorkoutStateActive = 0x01,
    /// Paused
    FitCloudCompanionWorkoutStatePaused = 0x02,
};

/// Companion Workout Initiator Definitions
typedef NS_ENUM(NSInteger, FitCloudCompanionWorkoutInitiator) {
    /// App
    FitCloudCompanionWorkoutInitiatorApp = 1,
    /// Device
    FitCloudCompanionWorkoutInitiatorDevice = 2,
};
...
typedef NS_ENUM(NSInteger, WORKOUTDATAITEMDISPLAY) {
    ...
    /// 平均心率 (与 2 同为平均心率，供文案不同的设备使用)
    WORKOUTDATAITEMDISPLAY_AVG_BPM_EX = 21,
    /// 最大心率
    WORKOUTDATAITEMDISPLAY_MAX_BPM = 22,
    /// 最小心率
    WORKOUTDATAITEMDISPLAY_MIN_BPM = 23,
    /// 最大速度
    WORKOUTDATAITEMDISPLAY_MAX_SPEED = 24,
    /// 最小速度
    WORKOUTDATAITEMDISPLAY_MIN_SPEED = 25,
    /// 最快配速
    WORKOUTDATAITEMDISPLAY_FASTEST_PACE = 26,
    /// 最慢配速
    WORKOUTDATAITEMDISPLAY_SLOWEST_PACE = 27,
    /// 最大步频
    WORKOUTDATAITEMDISPLAY_MAX_STEP_CADENCE = 28,
    /// 最小步频
    WORKOUTDATAITEMDISPLAY_MIN_STEP_CADENCE = 29,
    /// 心率五段区间
    WORKOUTDATAITEMDISPLAY_HEART_RATE_ZONES = 30,
    /// GPS 轨迹
    WORKOUTDATAITEMDISPLAY_GPS_TRACK = 31,
    /// 实时速度
    WORKOUTDATAITEMDISPLAY_REALTIME_SPEED = 32,
    /// 实时心率
    WORKOUTDATAITEMDISPLAY_REALTIME_BPM = 33,
};
...
#pragma mark AIAsking Agent

/// AI agent selected for single-turn AIAsking requests.
typedef NS_ENUM(NSInteger, FitCloudAIAskingAgent) {
    /// No AIAsking agent has been selected.
    FitCloudAIAskingAgentUnspecified = 0,

    /// Doubao.
    FitCloudAIAskingAgentDoubao,

    /// DeepSeek.
    FitCloudAIAskingAgentDeepSeek,

    /// ChatGLM.
    FitCloudAIAskingAgentChatGLM,

    /// ERNIE Bot.
    FitCloudAIAskingAgentERNIEBot,

    /// Qwen.
    FitCloudAIAskingAgentQwen,

    /// Spark.
    FitCloudAIAskingAgentSpark,

    /// Kimi.
    FitCloudAIAskingAgentKimi,
};
...
#pragma mark - AI function sessions

/// Audio source selected for an AI business request initiated by the device.
///
/// The source determines whether FitCloudKit participates in subsequent audio transport. App-
/// initiated SDK sessions always use `FitCloudAIAudioSourceDeviceOpus`; this type is exposed so the
/// app can interpret and accept or reject a device-initiated request.
typedef NS_ENUM(NSInteger, FitCloudAIAudioSource) {
    /// Unknown or unavailable source.
    FitCloudAIAudioSourceUnknown = -1,
    /// Bluetooth SCO audio. The app and system audio stack own the complete audio flow; FitCloudKit
    /// only passes the source selected by the device.
    FitCloudAIAudioSourceBluetoothSCO,
    /// Opus audio captured by the device and transported to the app through FitCloudKit.
    FitCloudAIAudioSourceDeviceOpus,
    /// The app uses the phone microphone and owns permission, capture, and lifetime. FitCloudKit
    /// only passes the source selected by the device.
    FitCloudAIAudioSourcePhoneMicrophone,
};

/// Reason why the device interrupted an active AI business session.
typedef NS_ENUM(NSInteger, FitCloudAIDeviceInterruptionReason) {
    /// Unknown or unrecognized reason.
    FitCloudAIDeviceInterruptionReasonUnknown = -1,
    /// The device ended the session normally.
    FitCloudAIDeviceInterruptionReasonNormal,
    /// The device battery level is too low to continue.
    FitCloudAIDeviceInterruptionReasonLowBattery,
    /// An incoming call interrupted the session.
    FitCloudAIDeviceInterruptionReasonIncomingCall,
    /// An active workout interrupted the session.
    FitCloudAIDeviceInterruptionReasonWorkout,
    /// Another device-side reason.
    FitCloudAIDeviceInterruptionReasonOther,
};

/// Device-side reason why an app-initiated AI business session did not start.
typedef NS_ENUM(NSInteger, FitCloudAIDeviceSideStartFailureReason) {
    /// The device started the session successfully.
    FitCloudAIDeviceSideStartFailureReasonNone,
    /// The device reported a start failure without a more specific reason.
    FitCloudAIDeviceSideStartFailureReasonUnspecified,
    /// The device battery level is too low to start.
    FitCloudAIDeviceSideStartFailureReasonLowBattery,
    /// An incoming call prevented the device from starting.
    FitCloudAIDeviceSideStartFailureReasonIncomingCall,
    /// An active workout prevented the device from starting.
    FitCloudAIDeviceSideStartFailureReasonWorkout,
    /// Another device-side start failure.
    FitCloudAIDeviceSideStartFailureReasonOther,
};

/// Reason why the app rejects a device-requested AI business start.
typedef NS_ENUM(NSInteger, FitCloudAIStartRejectionReason) {
    /// The app-side business service failed to start.
    FitCloudAIStartRejectionReasonServiceFailed,
    /// The app could not authorize the AI service.
    FitCloudAIStartRejectionReasonAuthenticationFailed,
    /// Another app-side reason.
    FitCloudAIStartRejectionReasonOther,
};

/// Translation voice business mode.
typedef NS_ENUM(NSInteger, FitCloudAITranslationVoiceMode) {
    /// Standard one-way translation.
    FitCloudAITranslationVoiceModeStandard,
    /// Conversation translation using the local user's voice.
    FitCloudAITranslationVoiceModeConversationSelf,
    /// Conversation translation using the other participant's voice.
    FitCloudAITranslationVoiceModeConversationOther,
};
